...
dir1 <- "/Volumes/scRNAseq_1/DESeq runs/P3_vs_GSE66053/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "p3_vs_GSE66053.csv"), header = TRUE)
...
names(files) <- paste0(samples$Well.number, "_sample", 1:121)
...
write.csv(res, file = 
            "/Volumes/scRNAseq_1/DESeq runs/P3_vs_GSE66053/Analysis/p3vsGSE66053_deseq.csv")
