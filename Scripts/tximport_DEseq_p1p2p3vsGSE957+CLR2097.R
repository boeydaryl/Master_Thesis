...
dir1 <- "/Volumes/scRNAseq_1/p1p2p3vsGSE957+CLR2097/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "p1p2p3vsGSE113957+CLR2097.csv"), header = TRUE)
...
names(files) <- paste0(samples$Well.number, "_sample", 1:151)
...
write.csv(res, file = "/Volumes/scRNAseq_1/p1p2p3vsGSE957+CLR2097/Analysis/deseq_full.csv")
