...
dir1 <- "/Volumes/scRNAseq_1/DESeq runs/P2_vs_GSE66053/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "p2_vs_GSE66053.csv"), header = TRUE)
...
write.csv(res, file = 
            "/Volumes/scRNAseq_1/DESeq runs/P2_vs_GSE66053/Analysis/p2vsGSE66053_deseq.csv")
