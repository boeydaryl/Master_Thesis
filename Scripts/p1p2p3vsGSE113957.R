...
dir1 <- "/Volumes/scRNAseq_1/DESeq runs/p1p2p3_vs_GSE113957/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "p1p2p3vsGSE113957.csv"), header = TRUE)
...
names(files) <- paste0(samples$Well.number, "_sample", 1:148)
...
write.csv(res, file = 
            "/Volumes/scRNAseq_1/DESeq runs/p1p2p3_vs_GSE113957/Analysis/p1p2p3vsGSE113957_deseq.csv")
