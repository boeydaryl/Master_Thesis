...
dir1 <- "/Volumes/scRNAseq_1/GSE113957vsCLR2097/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "GSE113957vsCLR2097.csv"), header = TRUE)
...
names(files) <- paste0(samples$Well.number, "_sample", 1:10)
...
write.csv(res, file = "/Volumes/scRNAseq_1/GSE113957vsCLR2097/Analysis/GSE113957vsCLR2907_deseq.csv")
