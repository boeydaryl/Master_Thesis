...
dir1 <- "/Volumes/scRNAseq_1/DESeq runs/p4p5_vs_GSE113957+GSE66053/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "p4p5vsGSE113957+GSE66053.csv"), header = TRUE)
...
names(files) <- paste0(samples$Well.number, "_sample", 1:178)
...
write.csv(res, file = 
            "/Volumes/scRNAseq_1/DESeq runs/p4p5_vs_GSE113957+GSE66053/Analysis/p4p5vsGSE113957+GSE66053_deseq.csv")
