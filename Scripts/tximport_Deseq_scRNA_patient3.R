...
samples <- read.csv(file.path(dir1, "patient_3_layout.csv"), header = TRUE)
dir2 <- "/Volumes/scRNAseq_1/SS2_15_0150-0151/salmon_quant_3/"
...
res <- results(dds)
res
res_p3 <- res[ ! (is.na(res$pvalue) | is.na(res$padj)), ]
geneLevelStats_p3 <- as.data.frame(res_p3[,c("log2FoldChange","padj")])
