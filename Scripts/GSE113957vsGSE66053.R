...
dir1 <- "/Volumes/scRNAseq_1/DESeq runs/GSE113957vsGSE66053/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "GSE113957vsGSE66053.csv"), header = TRUE)
...
write.csv(res, file = 
            "/Volumes/scRNAseq_1/DESeq runs/GSE113957vsGSE66053/Analysis/GSE113957vsGSE66053_deseq.csv")
