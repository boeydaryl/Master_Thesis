...
dir1 <- "/Volumes/scRNAseq_1/P2_vs_GSE113957/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "P2_vs_GSE113957.csv"), header = TRUE)
...
names(files) <- paste0(samples$Well.number, "_sample", 1:54)
...
write.csv(res, file = "/Volumes/scRNAseq_1/P2_vs_GSE113957/Analysis/p2vsGSE957_deseq.csv")