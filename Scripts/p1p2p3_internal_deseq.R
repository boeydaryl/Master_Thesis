...
dir1 <- "/Volumes/scRNAseq_1/DESeq runs/p1p2p3_internal/"

#### To load sample metadata and search for related salmon files #####
samples <- read.csv(file.path(dir1, "p1p2p3_internal.csv"), header = TRUE)
...
write.csv(res, file = 
            "/Volumes/scRNAseq_1/DESeq runs/p1p2p3_internal/p1p2p3_internal_deseq.csv")
